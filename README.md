...
- [`pithos.guild/`](./pithos.guild) — isolated .NET, Angular, TypeScript, and Rust architecture and implementation Guild members. [![npm version](https://img.shields.io/npm/v/@pithos-kit/guild.svg)](https://www.npmjs.com/package/@pithos-kit/guild)
